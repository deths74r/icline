...
/* U+1160..U+11FF, U+D7B0..U+D7C6, U+D7CB..U+D7FB (conjoining Hangul jamo
 * vowels/finals) added manually: wcwidth-heritage terminals (xterm, kitty,
 * foot) render them zero-width, so cursor math must agree; zeroing V/T also
 * makes grapheme width of decomposed Hangul (L+V+T) come out at 2 by plain
 * summation. */
