...
# endif
/* Suppress unused-function warnings in amalgamation mode.
 * The single-TU build includes all .c files, so functions
 * used only from certain files appear unused to others. */
# ifdef __GNUC__
